...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { detail: @experience.detail, summary: @experience.summary }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { detail: @experience.detail, summary: @experience.summary }
    assert_redirected_to experience_path(assigns(:experience))
  end
